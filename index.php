...
<body>
  ...
  <form id="frm" class="mb-3" method="POST">
    ...
    <video id="video" width="300" height="300" autoplay muted style="position: absolute; top: 0%; ;"></video>
      <!--src="./public/assets/img/video.mp4" loop muted playsinline preload="auto" poster="./public/assets/img/video.png"-->
            ...
            <div class="card-body">
              ...
              <div class="app-brand justify-content-center">
                <a href="index.html" class="app-brand-link gap-2">
                  ...
                  <span class="app-brand-text demo text-body fw-bolder">Registro Asistencia</span>
                </a>
              </div>
              <!-- /Logo -->
